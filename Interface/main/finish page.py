...
label1 = Label(root, text="Finished!", font=("Courier New", 140, "bold"),background="white")
label1.place(relx=0.5, rely=0.27, anchor=CENTER)

# Open image 
pic = Image.open("/Users/Onlyjune/Desktop/Yor/image/laundry-machine.png")
...
label2.place(relx=0.45, rely=0.6, anchor=CENTER)
