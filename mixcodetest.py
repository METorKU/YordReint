...
class app:
    ...
    def coin(self):
        ...
        label_coin(relx=0.37,rely=0.5, anchor=CENTER)
    ...
    def third_page(self,mode_c):
        ...
        if recieved < max_amount:
            self.button2=Button(self.frame3, text = "Go >", font=("Courier New", 20),height = 2, width = 6)
    ...
    def sixth_page(self):
        ...
        thread2 = Thread(target = wash(mode))
        thread1 = Thread(target = self.countdown(mode_type))
        thread1.start()
        thread2.start()
